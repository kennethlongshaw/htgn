...
class TGNMemory(torch.nn.Module):
    ...
    def _update_msg_store(self, src: Tensor, dst: Tensor, t: Tensor,
        ...
        # sorts src with tensor.sort() and returns n_id and perm
        # gets count of n_id with unique_consecutive and returns counts = true. returns n_id and count
        # for each item in n_id and perm, msg store is updated with src, dst, t, raw_msg after idx lookup
        n_id, perm = src.sort()
    ...
    def _compute_msg(self, n_id: Tensor, msg_store: TGNMessageStoreType,
                     msg_module: Callable):
        # fetches records for n_id from message store
        # to get src, dst, t, raw msg
        # fetches last update for src node
        # calcs t minus last update to get t_rel
        # encodes t_rel to t_rel_enc
        # fetches last memory of src and dst
        # processes src_mem, dst_mem, raw_msg and t_rel_enc through msg module
        # output of msg module is msg
        # returns msg, t, src, dst
        pass
